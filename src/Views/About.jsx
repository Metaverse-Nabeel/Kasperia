  ...
  return (
    <>
      <div className="flex justify-between items-center h-5/6 w-full mt-32 px-32">
        <div className="flex flex-col flex-wrap w-48 font-normal text-8xl">
          who are we?
          <div className="flex py-2 w-24 border-b-8 border-black" />
        </div>
        <div className="flex flex-wrap py-2 w-2/3 font-thin text-6xl text-left">
      ...
      <div className="flex flex-col h-5/6 my-32 px-32">
        <div className="flex flex-col justify-start items-end">
          <p className="text-left font-normal w-1/5 text-8xl">
            mission and vision
            <div className="py-2 w-24 border-b-8 border-black" />
          </p>
        </div>
        <div className="flex py-2 w-1/2 font-thin text-6xl text-left">
